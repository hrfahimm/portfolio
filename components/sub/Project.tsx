...
export default function Project({
    ...
    return (
        <motion.div
            ...
            <section
                className=' bg-[#dbdee7a2]   sm:w-[600px] w-[400px] h-[300px] pt-8 px-4  border border-black/5 overflow-hidden   relative  flex flex-row  hover:bg-[#DBDEE7] transition rounded-2xl   dark:bg-[#243b5c] dark:hover:bg-[#34517a] 
                ...
                <div className=' static sm:px-2 px-1 w-[200px] sm:w-[300px] flex flex-col h-full  '>
                    ...
                    <p className='mt-2 text-[10px] leading-relaxed   pb-2'>{description}</p>
                    ...
                    <a
                        href={gitUrl}
                        target='_blank'
                        className='   absolute bottom-5  text-sm cursor-pointer font-bold   flex items-center gap-2 rounded-full outline-none'>
                        Sourch Code{" ->"}
                        <Image
                            src={github}
                            alt='arrow'
